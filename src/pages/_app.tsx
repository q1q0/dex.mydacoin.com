  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">MYDA SWAP</title>

        <meta
          key="description"
          name="description"
          content="Be a DeFi Chef with MYDA. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />
        ...
        <meta
          ...
          content="Be a DeFi Chef with MYDA. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />
        <meta key="twitter:image" name="twitter:image" content="https://dex.mydacoin.com/icons/icon-192x192.png" />
        <meta key="twitter:creator" name="twitter:creator" content="@MYDASwap" />
        ...
        <meta key="og:image" property="og:image" content="https://dex.mydacoin.com/apple-touch-icon.png" />
        <meta
          key="og:description"
